  ...
  <div class="header-container">
    <div class="wrapper">
      ...
      <div class="right-wrapper">
        ...
        <el-dropdown class="name" v-if="name != ''" @command="loginMenu">
          ...
          <el-dropdown-menu class="user-name-wrapper" slot="dropdown">
            ...
            <el-dropdown-item command="/patient">预约用户管理</el-dropdown-item>
...
<!--          <el-button-group style="text-align: left;margin: 10px auto auto 10px;width: 100%;">-->
<!--            <el-button size="mini" :type="phoneBtn" @click="phoneFun">手机</el-button>-->
<!--            <el-button size="mini" :type="emailBtn" @click="emailFun">邮箱</el-button>-->
<!--          </el-button-group>-->
  ...
  methods: {
    ...
    btnClick() {
      ...
      if(this.dialogAtrr.loginBtn == '获取验证码') {
        if (this.dialogAtrr.showLoginType == 'phone'){
          this.userInfo.phone = this.dialogAtrr.inputValue
        }else if(this.dialogAtrr.showLoginType == 'email'){
    ...
    // 获取验证码
    getCodeFun() {
      if(this.dialogAtrr.showLoginType == 'phone' && !(/^1[34578]\d{9}$/.test(this.userInfo.phone))){
      ...
      // else if(this.dialogAtrr.showLoginType == 'email'){
      //   mailApi.sendCode(this.userInfo.email).then(response => {
      //     this.timeDown();
      //   }).catch(e => {
      //     this.$message.error('发送失败，重新发送')
      //     // 发送失败，回到重新获取验证码界面
    ...
    phoneFun() {
      ...
      this.emailBtn = ""
      this.dialogAtrr.showLoginType = 'phone'
      this.dialogAtrr.labelTips = '手机号码'
      this.dialogAtrr.placeholder = '请输入您的手机号'
      this.dialogAtrr.maxlength = 11
    },
    emailFun(){
      this.phoneBtn = ""
      this.emailBtn = "primary"
      this.dialogAtrr.showLoginType = 'email'
      this.dialogAtrr.labelTips = '邮箱'
      this.dialogAtrr.placeholder = '请输入您的邮箱'
      this.dialogAtrr.maxlength = 50
    },
    querySearchAsync() {

                ...
                <div class="wrapper">
                  ...
                  <div class="bottom-container">
                    <div class="icon-wrapper">
                      <span class="iconfont"></span>{{ item.param.hostypeName }}
                    </div>
                    <div class="icon-wrapper">
      ...
      <div class="right">
        <div class="common-dept">
          <div class="header-wrapper">
            <div class="title"> 常见服务</div>
            <div class="all-wrapper"><span>全部</span>
              <span class="iconfont icon"></span>
            </div>
          </div>
          <div class="content-wrapper">
            <span class="item v-link clickable dark">松骨 </span>
            <span class="item v-link clickable dark">美容 </span>
            <span class="item v-link clickable dark">汗蒸 </span>
            <span class="item v-link clickable dark">针灸 </span>
            <span class="item v-link clickable dark">足疗 </span>
            <span class="item v-link clickable dark">按摩 </span>
            <span class="item v-link clickable dark"> 采耳 </span>
            <span class="item v-link clickable dark">水疗 </span>
          </div>
        </div>
        <div class="space">
          <div class="header-wrapper">
          ...
          <div class="content-wrapper">
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark">关于延长华夏良子装修的通知 </span>
            </div>
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark">艺都水会新服务通知 </span>
            </div>
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark"> 沐云系统更新通知 </span>
            </div>
          </div>
        </div>
        <div class="suspend-notice-list space">
          ...
          <div class="content-wrapper">
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark"> 上善若水停业公告 </span>
            </div>
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark"> 天上人间停业整顿公告 </span>
            </div>
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark">华清泉装修停业 </span>
            </div>
          </div>
        </div>
      </div>

<template>
  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item ">
        <span class="v-link clickable dark" onclick="javascript:window.location='/order'"> 订单 </span>
      </div>
      <div class="nav-item selected">
        <span class="v-link selected dark" onclick="javascript:window.location='/patient'"> 预约用户管理 </span>
      </div>
      <div class="nav-item ">
    ...
    <div class="page-container">
      <div class="personal-patient">
        <div class="title" style="margin-top: 0px;font-size: 16px;"> 预约用户详情</div>
        <div>
          <div class="sub-title">
            <div class="block"></div>
            预约用户信息
          ...
          <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left">
              ...
              <br/>
              <el-form-item>
                <el-button class="v-button" type="primary" @click="remove()">删除预约用户</el-button>
                <el-button class="v-button" type="primary white" @click="edit()">修改预约用户</el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>

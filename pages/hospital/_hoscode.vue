    ...
    <div class="nav left-nav">
      <div class="nav-item selected">
        <span class="v-link selected dark"
              :onclick="'javascript:window.location=\'/hospital/'+hospital.hoscode+'\''">服务预约 </span>
      </div>
      <div class="nav-item ">
        <span class="v-link clickable dark"
              :onclick="'javascript:window.location=\'/hospital/detail/'+hospital.hoscode+'\''"> 商家详情 </span>
      </div>
      <div class="nav-item">
        <span class="v-link clickable dark"
      ...
      <div class="nav-item "><span
        class="v-link clickable dark"> 商家公告 </span>
      </div>
      <div class="nav-item "><span
      ...
      <div class="hospital-home">
        <div class="common-header">
          <div class="title-wrapper"><span
            ...
            <div v-if="hospital.param" class="icon-wrapper">
              <span class="iconfont"></span>
              {{ hospital.param.hostypeName }}
            </div>
          </div>
        </div>
        <div class="info-wrapper">
          ...
          <div class="content-wrapper">
            ...
            <div class="line">
              ...
              <div class="space"><span class="label">预约时间：</span><span>{{ bookingRule.releaseTime }}</span></div>
              <div class="space"><span class="label">停止预约时间：</span><span>{{ bookingRule.stopTime }}</span></div>
            </div>
            <div class="line"><span class="label">退号时间：</span>
              <span v-if="bookingRule.quitDay == -1">服务前一工作日{{ bookingRule.quitTime }}前取消</span>
              <span v-if="bookingRule.quitDay == 0">服务前当天{{ bookingRule.quitTime }}前取消</span>
            </div>
            <div style="margin-top:20px"> 商家预约规则</div>
<!--            <div class="rule-wrapper">
        ...
        <div class="title select-title"> 选择服务</div>

  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      <div class="nav-item selected">
        <span class="v-link selected dark" :onclick="'javascript:window.location=\'/hospital/'+schedule.hoscode+'\''">服务预约 </span>
      </div>
      <div class="nav-item ">
        <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/detail/'+schedule.hoscode+'\''"> 商家详情 </span>
      </div>
      <div class="nav-item">
    ...
    <div class="page-container">
      <div class="hospital-order">
        <div class="header-wrapper">
          <div class="title mt20"> 确认预约信息</div>
          <div>
            <div class="sub-title">
              <div class="block"></div>
              选择预约用户：
            ...
            <div class="sub-title" v-if="patientList.length > 0">
              <div class="block"></div>
              选择预约用户卡： <span class="card-tips"><span
            ...
            <div>
              ...
              <div class="content-wrapper">
                <el-form ref="form" :model="patient">
                  <el-form-item class="form-item" label="预约用户手机号：">
                    {{ patient.phone }}
                  </el-form-item>
                </el-form>
              </div>
